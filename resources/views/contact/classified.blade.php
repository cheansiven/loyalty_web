...
@section('content')
    ...
    <link href="{{ asset('css/wufoo-form.css') }}" rel="stylesheet"/>
    ...
    <div class="container" style="margin-bottom: 50px;">
            ...
            <div class="modal-dialog" style="margin-top: 17%">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><?php echo session("classified_card_id")?"Card Already Exists":"Email Already Exists"  ?></h4>
                    </div>
                    <div class="modal-body">

                        @if(session("classified_card_id"))
                    ...
                    <div class="modal-footer">
                                     <span class="pull-right">
                                        <form action="classified/yes" method="POST" id="option-no">
                                            {{csrf_field()}}
                                            <input type="submit" class="btn btn-primary" id="btn_resend_card" value="Yes" style="margin-left: 10px;"/>
                                        </form>
                                    </span>
                        <span class="pull-right">
                                        <form action="classified/no" method="POST" id="option-yes">
                                            {{csrf_field()}}
        ...
        <div class="col-md-10 col-md-offset-1 ">
            ...
            <form id="contact-form" action="classified/submit" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 text-center">
                        <div class="form-group text-center">
                            <label class="desc">Thumbnail <span class="star">*</span></label><br/>
                            <img id='img-upload' style="border: 1px solid #ccc;height: 150px;" src="{{ session("url_path_classified")?session("url_path_classified"):\URL::to('/')."/image/thumbnail.png" }}"/><br/>
