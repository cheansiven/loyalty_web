    ...
    <table border="0" cellpadding="0" cellspacing="0" height="100%" id="backgroundTable"
        ...
        <tr>
            ...
            <td align="center" valign="top">
                <table border="0" cellpadding="" cellspacing="20" width="100%" id="templatePreheader" style="background-color:#fff">
                                ...
                                <tr>
                                    <td valign="top">
                                        ...
                                        <div style="text-align:center;color:#000;">
                                            Having trouble viewing this email? <a href="https://classifiedrewards.haricrm.com/welcome-mail/{{ $serial_number }}/{{ $mail_data_id }}" target="_blank" style="color:#BC9B5D">
                                                click here</a>
