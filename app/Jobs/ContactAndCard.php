...
use App\Jobs\MainQueue;

class ContactAndCard extends MainQueue implements ShouldQueue
{
        ...
        if($contactId)
        {
            ...
            if(isset($all_data['card_id']) and $all_data['card_id'] !="")
            {
                ...
                if(!empty($check_voucher)){
                   ...
                   $this->_create_voucher($this->client, $connection, $all_data['contact_id'], $all_data['card_id']);
                }
                ...
                $this->_create_voucher($this->client, $connection, $all_data['contact_id'], $loyaltyCardId);
